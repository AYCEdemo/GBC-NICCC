...
; LCDC flags
LCDC_ON			EQU	%10000000 ; 0 = off, 1 = on
LCDC_WIN9C00	EQU	%01000000 ; 0 = 9800, 1 = 9C00
LCDC_WINON		EQU	%00100000 ; 0 = off, 1 = on
LCDC_BG8000		EQU	%00010000 ; 0 = 8800, 1 = 8000
LCDC_BG9C00		EQU	%00001000 ; 0 = 9800, 1 = 9C00
LCDC_OBJSIZE	EQU %00000100 ; 0 = 8x8, 1 = 8x16
LCDC_OBJON		EQU	%00000010 ; 0 = off, 1 = on
LDCD_BGPRIO		EQU	%00000001 ; 0 = off, 1 = on
